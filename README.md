...
R packages: TwoSampleMR (version 0.5.7), MendelianRandomization (version 0.10.0), MVMR (version 0.4), MRPRESSO (version 1.0), and MRlap (version 0.0.3.0).Code and data necessary to replicate the findings of the paper: Lifecourse influence of birthweight and subsequent pathways on healthy aging
